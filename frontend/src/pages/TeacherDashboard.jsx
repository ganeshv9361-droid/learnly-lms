...
export default function TeacherDashboard() {
  ...
  const createQuiz = async (e) => {
    ...
    try {
      const payload = {
        ...
        google_form_url:
          quizType === "google" ? quizForm.google_form_url : null,
  ...
  return (
    <div
      className={`min-h-screen ${bg} flex transition-colors duration-200 text-white`}
    >
      <div
        className={`hidden md:flex w-64 ${sidebar} border-r flex-col p-4 gap-1 shrink-0`}
      >
      ...
      <div className="flex-1 overflow-y-auto">
        {/* Mobile topbar */}
        <div
          className="md:hidden sticky top-0 z-40 flex items-center gap-3 px-4 py-3 border-b border-white/5"
          style={{
          ...
          {msg.text && (
            <div
              className={`text-xs px-3 py-1.5 rounded-xl ${
                msg.type === "error" ? "text-red-400" : "text-teal-400"
              }`}
            >
              {msg.text}
            </div>
        ...
        <div className="p-4 sm:p-6 pb-24 md:pb-6">
          ...
          {tab === "analytics" && (
            <div className="animate-fade-up">
              {!analyticsCourse ? (
                <div>
                  <div className={`text-sm font-semibold ${txt} mb-4`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {courses.map((c) => (
                      <div
                        key={c.id}
                        className={`${card} border rounded-xl p-4 cursor-pointer hover:border-violet-500/40 transition`}
                        onClick={() => setAnalyticsCourse(c)}
                      >
                        <div className={`font-medium ${txt} mb-1`}>
                          {c.title}
                        </div>
                ...
                <div>
                  ...
                  <CourseAnalytics
                    ...
                    courseName={analyticsCourse.title}
                  />
                </div>
              )}
            </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-6">
                {[
                  ...
                  <div key={label} className={`${card} border rounded-xl p-4`}>
                    <div
                      className={`text-xs ${txt3} uppercase tracking-wider mb-2`}
                    >
                      {label}
                    </div>
                ...
                {students.map((s) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className={`text-sm font-medium ${txt}`}>
                          {s.name}
                        </div>
                      ...
                      <div
                        className={`flex items-center gap-4 text-xs ${txt3}`}
                      >
                      ...
                      <div className={`border-t ${divider} p-4 bg-[#0f1117]`}>
                        ...
                        {s.enrollments?.length === 0 ? (
                          ...
                          s.enrollments?.map((e, i) => (
                            ...
                            >
                              <div
                                className={`flex-1 text-xs ${txt2} truncate`}
                              >
                                {e.course_title}
                              </div>
                              ...
                              <div
                                className={`text-xs ${txt2} w-10 text-right`}
                              >
                                {e.progress || 0}%
                              </div>
                            </div>
          ...
          {tab === "courses" && editCourse && (
            <div className="max-w-lg">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div className={`font-medium ${txt}`}>
                  Edit: {editCourse.title}
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-2 mb-4 max-h-64 overflow-y-auto">
                      ...
                      {videos.map((v, i) => (
                        ...
                        >
                          <div
                            className={`w-6 h-6 bg-white/5 rounded text-xs flex items-center justify-center ${txt2}`}
                          >
                            {i + 1}
                          </div>

                          <div className="flex-1 min-w-0">
                            <div className={`text-sm ${txt} truncate`}>
                              {v.title}
                            </div>
                            <div className={`text-xs ${txt3}`}>
              ...
              {courseTab === "submissions-tab" && (
                <div>
                  ...
                  {submissions.length === 0 && (
                    <div className={`text-sm ${txt3}`}>
                      No submissions yet. Click "View submissions" on an
                      assignment.
                    </div>
                  )}
                    ...
                    <form onSubmit={createQuiz} className="space-y-3">
                      ...
                      {quizType === "google" ? (
                        <div>
                          ...
                          <div className={`text-xs ${txt3} mt-1`}>
                            Students will see this form embedded in their
                            dashboard
                          </div>
                        </div>
                      ) : (
            ...
            <div className="animate-fade-up grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className={`${card} border rounded-2xl p-5`}>
                ...
                <div className="space-y-3">
                  <div>
                    <label className={lbl}>
                      Course (leave empty for all courses)
                    </label>
                    <select
                    ...
                    onClick={async () => {
                      try {
                        await api.post("/coupons/create", {
                          course_id: couponForm.course_id
                            ? parseInt(couponForm.course_id)
                            : null,
              ...
              <div>
                <div className={`text-sm font-semibold ${txt2} mb-3`}>
                  Your Coupons ({coupons.length})
                </div>
                <div className="space-y-2">
                  {coupons.length === 0 && (
                    <div className={`text-sm ${txt3}`}>No coupons yet</div>
                  )}
                  {coupons.map((c) => (
                    <div key={c.id} className={`${card} border rounded-xl p-4`}>
                      ...
                      <div className={`text-xs ${txt2}`}>
                        {c.course} · {c.discount_percent}% off
                      </div>
                      <div className={`text-xs ${txt3}`}>
                        {c.used_count}/{c.max_uses} used · Expires{" "}
                      ...
                      <button
                        ...
                        className="text-xs mt-2 text-teal-400 hover:underline"
                      >
                        📋 Copy code
                      </button>
                    </div>
          ...
          {tab === "live" && (
            <div className="animate-fade-up grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setLiveForm({ ...liveForm, meet_link: e.target.value })
                      }
                      className={inp}
              ...
              <div>
                ...
                <div className={`text-sm ${txt3}`}>
                  Students will see the Join button automatically and get
                  notified
                </div>
              </div>
            </div>
