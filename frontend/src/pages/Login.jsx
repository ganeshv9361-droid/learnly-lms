  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4"
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        ...
        <div className="absolute w-72 h-72 rounded-full border opacity-5"
          style={{borderColor:'#06b6d4',animation:'spinSlow 15s linear infinite reverse'}}/>
      </div>
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="card-base animate-fade-up delay-100 p-6 sm:p-8"
          ...
          <div className="mb-6">
            <p className="text-sm mt-2 text-white">Welcome back</p>
